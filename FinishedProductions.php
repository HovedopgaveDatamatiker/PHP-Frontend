...
<div class="wrapper-right">
    ...
    $template = $twig->loadTemplate('alledone.html.twig'); //referer til allecoins.html.twig.twig så den kan bruges
    $uri = "http://storageservice2018.azurewebsites.net/Service1.svc/done";
    $json = file_get_contents($uri);
    $Liste = json_decode($json); //fortæller jeg gerne vil have det i json
    $twigContent = array ("Done" => $Liste); // laver et array med min variabel $liste
    #print_r($twigContent);
