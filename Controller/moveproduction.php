...
$template = $twig->loadTemplate('redirect_movetodone.html.twig');
$con = new stdClass();
$con ->Id = $_REQUEST['Id'];
...
// set up PUT request
$URI = "http://storageservice2018.azurewebsites.net/Service1.svc/productiontodone";
...
$twigContent = array("Productions" => $Liste); // fill in the content for the page
